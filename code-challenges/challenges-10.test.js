...
const createServer = () => {
  ...
  app.get('/hello', (req, res) => res.send('Hellooo folks'));
  app.get('/aboutme', (req, res) => res.send('AF, Wood, Birds'));
  app.get('/favoritefoods', (req, res) => res.send(['water', 'tea', 'milk']));
